...
async def main():
    ...
    async with httpx.AsyncClient() as client:
        ...
        # await fetch_and_save(client, "Jujutsu Kaisen: Shimetsu Kaiyuu - Kouhen")
        ...
        # await fetch_and_save(client, "Go! Saitama")
        # await fetch_and_save(client, "One Punch Man: Road to Hero")
        # await fetch_and_save(client, "One Punch Man 3 Part 2")
        # await fetch_and_save(client, "Kimetsu no Yaiba: Mugen Ressha-hen")
        ...
        await fetch_and_save(client, "Oshi no Ko")
        await fetch_and_save(client, "Oshi no ko 2nd Season")
        await fetch_and_save(client, "Oshi no ko 3rd Season")
        await fetch_and_save(client, "MARRIAGETOXIN")
        await fetch_and_save(client, "Aishiteru Game wo Owarasetai")
        await fetch_and_save(client, "Tongari Boushi no Atelier")
        await fetch_and_save(client, "Tsue to Tsurugi no Wistoria Season 2")
        await fetch_and_save(client, "Tsue to Tsurugi no Wistoria")
        await fetch_and_save(client, "Tensei Shitara Slime Datta Ken 4th Season")
        await fetch_and_save(client, "Tensei Shitara Slime Datta Ken")
        await fetch_and_save(client, "Bananya At-Home Party")
        await fetch_and_save(client, "Bananya: Around the World")
        ...
        await fetch_and_save(client, "Kusuriya no Hitorigoto")
        await fetch_and_save(client, "Sono Bisque Doll wa Koi wo Suru Season 2")
        await fetch_and_save(client, "Sono Bisque Doll wa Koi wo Suru")
        await fetch_and_save(client, "Hikaru ga Shinda Natsu")
        await fetch_and_save(client, "Takopii no Genzai")
        await fetch_and_save(client, "SPY x FAMILY Season 3")
        await fetch_and_save(client, "SPY x FAMILY Season 2")
        await fetch_and_save(client, "Enen no Shouboutai: San no Shou")
        await fetch_and_save(client, "Enen no Shouboutai")
        await fetch_and_save(client, "Enen no Shouboutai: Ni no Shou")
        await fetch_and_save(client, "Enen no Shouboutai: San no Shou Part 2")
        await fetch_and_save(client, "Boku no Hero Academia FINAL SEASON")
        await fetch_and_save(client, "Yofukashi no Uta Season 2")
        await fetch_and_save(client, "Yofukashi no Uta")
        await fetch_and_save(client, "WIND BREAKER Season 2")
        await fetch_and_save(client, "WIND BREAKER")
    await close_db()
